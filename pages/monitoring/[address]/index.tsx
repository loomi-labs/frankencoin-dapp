		...
		<>
			...
			<div className="flex flex-col gap-4">
				...
				<div className="grid grid-cols-1 md:grid-cols-2 gap-4">
					<AppCard>
						<div className="gap-2">
							<div className="text-base font-display font-semibold text-text-primary mb-1">Usage</div>
					...
					<AppCard>
						<div className="gap-2">
							<div className="text-base font-display font-semibold text-text-primary mb-1">Collateral</div>
					...
					<AppCard>
						<div className="gap-2">
							<div className="text-base font-display font-semibold text-text-primary mb-1">Interest</div>
