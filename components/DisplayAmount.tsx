	...
	return (
		<div className={className || "pt-2"}>
			<div className="flex items-center gap-2">
				{output != undefined ? (
					<div className={`flex-1 text-text-primary font-mono ${bold && "font-medium"} ${big ? "text-lg" : ""}`}>{output}</div>
				) : (
					<div className={`flex-1 text-text-primary font-mono ${bold && "font-medium"} ${big ? "text-lg" : ""}`}>
